--[[	
	...
	LERP version 0.7.9:lerp(1.01patch) + KRUL version 0.8.4:krul(V3.3)
...
function RoClothes(Player)
	...
	local CVersion = "0.8.4:krul(V3.3)"
	...
	local fpCache = {ignoreList={}, dirty=true, lastChar=nil, conn1=nil, conn2=nil}
				...
				if lP and lP.Character then
					...
					if char:FindFirstChild("Head") and char:FindFirstChild("HumanoidRootPart") and char:FindFirstChildOfClass("Humanoid") then
						...
						if currentCamera then
							...
							local hit, pos = game.Workspace:FindPartOnRayWithIgnoreList(ray, fpCache.ignoreList)
